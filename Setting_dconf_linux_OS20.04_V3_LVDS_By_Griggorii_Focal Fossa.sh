...
window-properties=[578, 373, 719, 126]
...
recent-connections=[{'adapter': '00:19:86:00:2D:C5', 'address': '85:93:D4:DD:CD:68', 'alias': 'BT-M-100', 'icon': 'audio-card', 'name': 'Профили автоматического подключения', 'uuid': '00000000-0000-0000-0000-000000000000', 'time': '1583572063.6418185', 'device': '', 'mitem': ''}]
...
active-plugins=['colorpicker', 'filebrowser', 'colorschemer', 'findinfiles', 'externaltools', 'textsize', 'snippets', 'synctex', 'pythonconsole', 'spell', 'wordcompletion', 'commander', 'translate', 'docinfo', 'time', 'git', 'charmap', 'quickopen', 'modelines', 'bracketcompletion', 'quickhighlight']
...
[org/gnome/software]
check-timestamp=int64 1583762251
first-run=false
