...
favorites=['application://ubiquity.desktop', 'application://org.gnome.Nautilus.desktop', 'application://alacarte-made-12.desktop', 'application://google-chrome.desktop', 'application://firefox.desktop', 'application://org.gnome.Software.desktop', 'application://unity-control-center.desktop', 'unity://running-apps', 'application://com.gexperts.Tilix.desktop', 'application://libreoffice-startcenter.desktop', 'application://gnome-system-monitor.desktop', 'application://com.obsproject.Studio.desktop', 'unity://expo-icon', 'unity://devices']
...
active-plugins=['spell', 'modelines', 'docinfo', 'time', 'snippets', 'filebrowser', 'pythonconsole']
