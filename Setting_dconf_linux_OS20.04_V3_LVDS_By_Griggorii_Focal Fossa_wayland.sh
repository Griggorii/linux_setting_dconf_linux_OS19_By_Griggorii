...
pinned-launchers=['brave-browser.desktop', 'firefox.desktop', 'nemo.desktop', 'update-manager.desktop', 'org.gnome.Software.desktop', 'org.gnome.Maps.desktop', 'slingscold.desktop', 'org.gnome.Screenshot.desktop']
...
window-properties=[608, 373, 254, 156]
...
application-children=['gnome-control-center', 'org-gnome-tweaks', 'org-gnome-gedit', 'firefox', 'com-gexperts-tilix', 'mousepad', 'org-gnome-nautilus', 'org-gnome-terminal', 'org-gnome-fileroller', 'org-gnome-baobab']
show-banners=true
...
active-plugins=['colorschemer', 'charmap', 'textsize', 'snippets', 'time', 'bracketcompletion', 'quickhighlight', 'commander', 'colorpicker', 'externaltools', 'findinfiles', 'docinfo', 'spell', 'git', 'wordcompletion', 'quickopen', 'filebrowser', 'modelines', 'pythonconsole', 'synctex', 'translate']

[org/gnome/gedit/plugins/filebrowser]
root='file:///'
tree-view=true
virtual-root='file:///home/griggorii/mesa-20.1.0/build/meson-info'
...
enabled-extensions=['mediaplayer@patapon.info', 'impatience@gfxmonk.net', 'ubuntu-appindicators@ubuntu.com', 'ubuntu-dock@ubuntu.com', 'GPaste@gnome-shell-extensions.gnome.org', 'apps-menu@gnome-shell-extensions.gcampax.github.com', 'gnomenu@panacier.gmail.com', 'CoverflowAltTab@palatis.blogspot.com', 'popthemetoggle@kylecorry31.github.io', 'auto-ovpn@yahoo.com', 'printers@linux-man.org', 'openweather-extension@jenslody.de', 'sound-output-device-chooser@kgshank.net', 'bettervolume@tudmotu.com', 'dash-to-dock@micxgx.gmail.com', 'hidetopbar@mathieu.bidon.ca', 'suspend-button@laserb', 'TilixDropdown@ivkuzev@gmail.com', 'dash-to-panel@jderose9.github.com', 'system-monitor@paradoxxx.zero.gmail.com', 'user-theme@gnome-shell-extensions.gcampax.github.com']
favorite-apps=['xfce4-screenshooter.desktop', 'org.gnome.Screenshot.desktop', 'ubiquity.desktop', 'org.gnome.Nautilus.desktop', 'firefox.desktop', 'org.gnome.Software.desktop', 'gnome-control-center.desktop', 'libreoffice-startcenter.desktop', 'com.gexperts.Tilix.desktop', 'nemo.desktop', 'caja.desktop', 'pavucontrol.desktop', 'gnome-system-monitor.desktop']
...
[org/gnome/software]
check-timestamp=int64 1584695089
first-run=false
